...
import { Search, Bell, PanelLeft, X, ChevronRight, Sparkles } from 'lucide-react'
...
export default function TopBar() {
  ...
  return (
    <header className="h-14 shrink-0 flex items-center justify-between px-4 md:px-5 sticky top-0 z-20 bg-white/85 backdrop-blur-xl border-b border-border/60">
      ...
      <form onSubmit={handleSearchSubmit}
        className={cn(
          'relative mx-4 hidden md:flex flex-1 max-w-sm transition-all duration-200',
      ...
      <div className="flex items-center gap-1.5">
        ...
        <button onClick={openChat}
          className="ai-btn-gradient hidden sm:inline-flex items-center gap-1.5 rounded-xl px-3.5 py-2 text-[12px] font-bold text-white shadow-md shadow-violet-500/20 hover:shadow-violet-500/35 hover:-translate-y-px transition-all">
